                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="islem.php">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" name="bilgi_aciklama" autocomplete="off"  placeholder="Aşağıdaki ikonu seçiniz" required>
                        </div>
                        ...
                        <button type="submit" name="bilgi_ekle_gonder" class="btn btn-primary me-2">Gönder</button>
