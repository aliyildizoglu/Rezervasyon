                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="islem.php"  enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <select name="galeri_resim_durum" class="form-select" id="exampleFormControlSelect1" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file"  class="form-control"  autocomplete="off" name="galeri_resim" required>
                        </div>
